...
class DiagramPolygonItem : public QObject, public QGraphicsPolygonItem
{
    Q_OBJECT
...
public:
    ...
    DiagramPolygonItem(QGraphicsItem* parent = nullptr);
    DiagramPolygonItem(DiagramType diagramType, QMenu* contextMenu = nullptr, QGraphicsItem* parent = nullptr);
