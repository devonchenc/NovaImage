...
static void MakeHistogram(uchar*, unsigned int, unsigned int, unsigned int,
    unsigned long*, unsigned int, uchar*);
static void MapHistogram(unsigned long*, uchar, uchar,
    unsigned int, unsigned long);
static void MakeLut(uchar*, uchar, uchar, unsigned int);
static void Interpolate(uchar*, int, unsigned long*, unsigned long*,
    unsigned long*, unsigned long*, unsigned int, unsigned int, uchar*);
     ...
     */
{
    ...
    uchar* pImPointer;		   /* pointer to image */
    uchar aLUT[uiNR_OF_GREY];	    /* lookup table used for scaling of input image */
...
void MakeHistogram(uchar* pImage, unsigned int uiXRes,
    unsigned int uiSizeX, unsigned int uiSizeY,
    unsigned long* pulHistogram,
    unsigned int uiNrGreylevels, uchar* pLookupTable)
...
void MapHistogram(unsigned long* pulHistogram, uchar Min, uchar Max,
...
void MakeLut(uchar * pLUT, uchar Min, uchar Max, unsigned int uiNrBins)
...
void Interpolate(uchar * pImage, int uiXRes, unsigned long * pulMapLU,
    unsigned long * pulMapRU, unsigned long * pulMapLB, unsigned long * pulMapRB,
    unsigned int uiXSize, unsigned int uiYSize, uchar * pLUT)
