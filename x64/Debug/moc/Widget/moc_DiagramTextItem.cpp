...
QT_MOC_LITERAL(5, 49, 18), // "textSelectedChange"
QT_MOC_LITERAL(6, 68, 14) // "QGraphicsItem*"

    },
    "DiagramTextItem\0lostFocus\0\0DiagramTextItem*\0"
    "item\0textSelectedChange\0QGraphicsItem*"
};
...
void DiagramTextItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->textSelectedChange((*reinterpret_cast< QGraphicsItem*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DiagramTextItem::textSelectedChange)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void DiagramTextItem::textSelectedChange(QGraphicsItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
